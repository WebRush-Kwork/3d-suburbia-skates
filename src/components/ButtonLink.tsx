	...
	return (
		<Link
			className={clsx(
				...
				size === 'md' && 'gap-3 px-1 text-lg py-1 md:py-2.5 lg:py-3',
				size === 'lg' &&
					'md:text-lg lg:text-xl xl:text-2xl gap-2 md:gap-2.5 lg:gap-3 xl-gap-4 px-1 lg:px-2 xl:px-3 py-1 md:py-2 lg:py-3 xl:py-4',
				color === 'orange' && 'from-[#ff7347] to-[#d9f154] text-black',
				color === 'purple' &&
					'from-[#692e54] to-[#d9f154] text-white hover:text-black',
				color === 'lime' && 'from-[#d9f154] to-[#ff7347] text-black',
				className
			)}
			{...props}
			href={href}
				...
				<>
					<div
						className={clsx(
							...
							size === 'sm' && 'size-5',
							size === 'md' && 'size-6',
							size === 'lg' && 'md:size-6 lg:size-7 xl:size-8'
						)}
					>
